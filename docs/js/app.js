...
const postBeauty = function () {
  ...
  $.each('figure.highlight', function (element) {
    ...
    element.insertAdjacentHTML('afterBegin', '<figcaption></figcaption>');

    var code_container = element.child('.code-container');
    var caption = element.child('figcaption');
    console.log(caption, 'caption');

    element.insertAdjacentHTML('beforeend', '<div class="operation 45555555555333"><span class="breakline-btn"><i class="ic i-align-left"></i></span><span class="copy-btn"><i class="ic i-clipboard"></i></span><span class="fullscreen-btn"><i class="ic i-expand"></i></span></div>');
